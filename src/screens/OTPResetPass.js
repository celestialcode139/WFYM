...
function OTPResetPass() {
    ...
    const StoreData = (id) => {
        GeneralHelper.storeData("OTP_ID", id).then((result) => {
            if (result.status == 1) {
