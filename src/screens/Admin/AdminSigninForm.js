...
function AdminSigninForm() {
    ...
    const SignIn = () => {
        setLoading(true);
        APIHelper.CallApi(config.Endpoints.Team.Login, { email: Email, password: Password }, null, '').then((result) => {
    ...
    return (_jsx(Box, { className: `${classes.signinFrom}`, children: _jsxs(Container, { maxWidth: "lg", children: [_jsx(OnBoardingHeader, { heading: "Sign in" }), _jsx(Box, { component: "form", className: `h-center`, sx: {
                        "& .MuiTextField-root": { maxWidth: "300px", width: "100%" },
                                    ...
                                    }, type: "password", label: "Password", value: Password, onChange: (e) => { setPassword(e.target.value); } }) })] }) }), _jsx(Box, { sx: { marginTop: "20px" }, children: _jsx(Button, { sx: { maxWidth: "280px", margin: "0 auto!important" }, onClick: () => { Validation(); }, children: Loading == true ?
