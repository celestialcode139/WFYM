  ...
  return (
    <Box className={`${classes.quickProfileContainer}`}>
      ...
      <Box className={`${classes.pt20}`}>
        ...
        <Typography className={`p-12`}>{props.data.about}</Typography>
      </Box>
      <Box className={`${classes.pt20}`}>
        ...
        <Box>
          {props.data.interests.map((interest: any) => (
            <Box className={`${classes.badge} v-center`}>
              <Box component="img" src={DoubleTic}></Box>
              {interest}
            </Box>
          ))}
        </Box>
      ...
      <Box className={`${classes.pt20}`}>
        ...
        <Grid container spacing={1}>
          {props.data.gallery.map((galary: any) => (
            <Grid item xs={6}>
              <Box
                component="img"
