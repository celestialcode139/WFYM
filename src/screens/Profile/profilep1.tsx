...
function ProfileP1() {
  ...
  console.log("errorState", errorFieldsKeys.profile);
  console.log("errorState errorState", errorState);
  ...
  const handleUpdateCountry = (value) => {
    const UpdatedErrorState = errorState.filter((item) => item !== "country");
    setErrorState(UpdatedErrorState);
    setCountry(value);
  };
  const handleUpdateCity = (value) => {
    const UpdatedErrorState = errorState.filter((item) => item !== "city");
    setErrorState(UpdatedErrorState);
    setCity(value);
  };
  const handleUpdateAddress = (value) => {
    const UpdatedErrorState = errorState.filter((item) => item !== "location");
    setErrorState(UpdatedErrorState);
    setAddress(value);
  };
  // Other functions
  ...
  return (
    <Grid container>
      ...
      >
        {!Loading ? (
          <Box>
            {errorState.includes(errorFieldsKeys.profile.images) && (
              <Typography style={{ color: "red" }}>Required*</Typography>
            )}
            <Box
              className={`${classes.profileImage}`}
              style={{
                backgroundImage: `url(${profileImage.image_url})`,
              }}
            >
            ...
            <Grid container>
              ...
              <Grid item md={6} xs={12} sx={{ p: 1 }}>
                <TextField
                  ...
                  error={errorState.includes(errorFieldsKeys.profile.country)}
                  type="text"
                  label="Country"
                  value={Country}
                  onChange={(e: any) => handleUpdateCountry(e.target.value)}
                />
              </Grid>
              <Grid item md={6} xs={12} sx={{ p: 1 }}>
                <TextField
                  ...
                  error={errorState.includes(errorFieldsKeys.profile.city)}
                  type="text"
                  label="City"
                  value={City}
                  onChange={(e: any) => handleUpdateCity(e.target.value)}
                />
              </Grid>
              <Grid
                item
              ...
              <Grid item xs={12} sx={{ p: 1 }}>
                <TextField
                  ...
                  error={errorState.includes(
                    errorFieldsKeys.profile.description
                  )}
                />
              </Grid>
              <Grid item xs={12} sx={{ p: 1 }}>
                <TextField
                  ...
                  label="Address"
                  value={Address}
                  onChange={(e: any) => handleUpdateAddress(e.target.value)}
                  error={errorState.includes(errorFieldsKeys.profile.location)}
                />
              </Grid>
              {/* <Grid
                item
