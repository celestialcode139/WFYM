...
rgbeLoader.load("src/threejs/hdr/rural_asphalt_road_4k.hdr", (texture:any) => {
...
//===================================================== Create Heart images
// Image1
var imgGeo1 = new THREE.PlaneGeometry(0.02, 0.028, 50);
var imgMat1 = new THREE.ShaderMaterial({
vertexShader,
fragmentShader,
uniforms: {
  maxDistance: { value: 3 }, // Adjust the maximum distance
  imageTexture: { value: new THREE.TextureLoader().load("src/threejs/assets/images/1.png")},
},
});
var img1 = new THREE.Mesh(imgGeo1, imgMat1);
img1.position.set(0, 0.01407, -0.07);
img1.rotation.z = -4.35 * (Math.PI / 180);
// Image2
var imgGeo2 = new THREE.PlaneGeometry(0.02, 0.028, 50);
var imgMat2 = new THREE.ShaderMaterial({
vertexShader,
fragmentShader,
uniforms: {
  maxDistance: { value: 3 }, // Adjust the maximum distance
  imageTexture: { value: new THREE.TextureLoader().load("src/threejs/assets/images/2.png")},
},
});
var img2 = new THREE.Mesh(imgGeo2, imgMat2);
img2.position.set(0.01131, 0.00858, -0.065);
img2.rotation.z = -50.32 * (Math.PI / 180);

// Image3
var imgGeo3 = new THREE.PlaneGeometry(0.02, 0.028, 50);
var imgMat3 = new THREE.ShaderMaterial({
vertexShader,
fragmentShader,
uniforms: {
  maxDistance: { value: 3 }, // Adjust the maximum distance
  imageTexture: { value: new THREE.TextureLoader().load("src/threejs/assets/images/3.png")},
},
});
var img3 = new THREE.Mesh(imgGeo3, imgMat3);
img3.position.set( 0.0066, -0.01248, -0.06663);
img3.rotation.z = 22.87 * (Math.PI / 180);
// Image4
var imgGeo4 = new THREE.PlaneGeometry(0.02, 0.028, 50);
var imgMat4 = new THREE.ShaderMaterial({
vertexShader,
fragmentShader,
uniforms: {
  maxDistance: { value: 3 }, // Adjust the maximum distance
  imageTexture: { value: new THREE.TextureLoader().load("src/threejs/assets/images/4.png")},
},
});
var img4 = new THREE.Mesh(imgGeo4, imgMat4);
img4.position.set(-0.00535, -0.01277, -0.06711);
img4.rotation.z = -24.84 * (Math.PI / 180);
// Image5
var imgGeo5 = new THREE.PlaneGeometry(0.02, 0.028, 50);
var imgMat5 = new THREE.ShaderMaterial({
vertexShader,
fragmentShader,
uniforms: {
  maxDistance: { value: 3 }, // Adjust the maximum distance
  imageTexture: { value: new THREE.TextureLoader().load("src/threejs/assets/images/5.png")},
},
});
var img5 = new THREE.Mesh(imgGeo5, imgMat5);
...
var directionallight = new THREE.DirectionalLight("white", 2);
var ambientLight = new THREE.AmbientLight("blue", 0.2);
...
tl.to(mainGroup.position, {x:0,y:0, duration: 0.8, ease: "power1.inOut" });
heartGlobal.traverse((child:any) => {
  if (child.isMesh) {
    ...
    if (
      ...
      tl.to(child.material, {opacity:0.5, duration: 0.8, ease: "power1.inOut" });
      tl.to(child.material, {opacity:1, duration: 0.8, ease: "power1.inOut" });
...
tl.to(imageGroup.rotation, { z:-Math.PI*2, duration: 1.5, ease: "power1.inOut" },"-=1.5");

tl.to(img1.position, { x: -0.02306, y: 0.0132, z: 0.575, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img1.rotation, { z: 0.67796, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img2.position, { x: 0.01215, y: -0.01283, z: 0.5754, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img2.rotation, { z:-1.11739, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img3.position, { x: -0.01446, y: -0.01323 ,z: 0.5753,  duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img3.rotation, { z: 1.02353, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img4.position, { x: 0.01966, y: 0.01099, z: 0.5752, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img4.rotation, { z: 0.77481, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img5.position, { x: -0.00032, y: 0.02025, z: 0.5751, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(img5.rotation, { z: -0.2694, duration: 1.5, ease: "power1.inOut" },"-=1.5");
tl.to(heartGlobal.position, { y: 0.5, duration: 0.5, ease: "power1.inOut" });
}, 500);
