...
`;
        //===================================================== Variables
        let canvas, heartGlobal, gltfloader = new GLTFLoader(), WIDTH = window.innerWidth, rgbeLoader = new RGBELoader(), mainGroup = new THREE.Group(), textGroup = new THREE.Group(), HEIGHT = window.innerHeight;
        ...
        window.addEventListener("scroll", function (event) {
            ...
            const progress = (window.pageYOffset - track?.offsetTop) / (trackHeight - windowHeight);
    ...
    return (_jsxs(Box, { className: `landingPage`, children: [_jsx(Header, {}), _jsx(HeroSection, {}), _jsxs("div", { className: "p-relative animationHeight", children: [_jsxs("div", { children: [_jsx("img", { className: "mgif", style: { position: "absolute", left: "10%", top: "30%" }, src: Key }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "50%", top: "30%" }, src: LoveYou }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "88%", top: "30%" }, src: LoveBirds }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "25%", top: "50%" }, src: Mail }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "70%", top: "50%" }, src: Marriage }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "10%", top: "70%" }, src: Sunglasses }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "50%", top: "70%" }, src: TaddyBear }), _jsx("img", { className: "mgif", style: { position: "absolute", left: "88%", top: "70%" }, src: GreatPyrenees })] }), _jsx("canvas", { className: "canvas" })] }), _jsx(Footer, {})] }));
}
export default App;
