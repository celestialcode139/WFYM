...
function SignupProfile() {
    ...
    const featchData = async () => {
        ...
        if (Signup_Details.status == 1 && UserDetails_Names.status == 1) {
            const SignupDetails = JSON.parse(Signup_Details.data);
            const UserDetailsNames = JSON.parse(UserDetails_Names.data);
            const data = {
    ...
    const SignUp = (data) => {
        APIHelper.CallApi(config.Endpoints.auth.SignUp, data, null, '').then((result) => {
    ...
    return (_jsxs(Box, { className: `${classes.SignupProfile}`, children: [_jsxs(Container, { maxWidth: "lg", children: [_jsx(OnBoardingHeader, { heading: "I am a" }), _jsx(Box, { className: "h-center", children: _jsxs(Box, { children: [_jsx(Button, { onClick: () => setSelectedGender("male"), sx: {
                                        ...
                                        marginTop: "20px",
                                        cursor: "pointer!important",
                                    }, children: _jsx(Box, { className: "v-center", children: _jsx(Typography, { children: "Other" }) }) }), _jsx(Button, { onClick: () => { featchData(); }, sx: {
                                        ...
                                        marginTop: "40px",
                                        cursor: "pointer!important",
                                    }, children: _jsx(Box, { className: "v-center", children: _jsx(Typography, { children: "Continue" }) }) })] }) })] }), _jsx(Link, { to: { pathname: "/signup-profile" }, children: _jsx(Box, { component: "img", src: backArrow, className: `${classes.backArrow} backButton hover` }) })] }));
}
